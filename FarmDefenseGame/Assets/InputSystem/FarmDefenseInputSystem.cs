...
//     version 1.11.2
//     from Assets/InputSystem/FarmDefenseInputSystem.inputactions
//
...
public partial class @FarmDefenseInputSystem: IInputActionCollection2, IDisposable
{
    public InputActionAsset asset { get; }
    public @FarmDefenseInputSystem()
    {
        asset = InputActionAsset.FromJson(@"{
    ""name"": ""FarmDefenseInputSystem"",
    ""maps"": [
        {
            ""name"": ""Battle"",
    ...
    {
        UnityEngine.Debug.Assert(!m_Battle.enabled, "This will cause a leak and performance issues, FarmDefenseInputSystem.Battle.Disable() has not been called.");
        UnityEngine.Debug.Assert(!m_Search.enabled, "This will cause a leak and performance issues, FarmDefenseInputSystem.Search.Disable() has not been called.");
        UnityEngine.Debug.Assert(!m_PlayerMenuUI.enabled, "This will cause a leak and performance issues, FarmDefenseInputSystem.PlayerMenuUI.Disable() has not been called.");
    }
    ...
    public struct BattleActions
    {
        ...
        public BattleActions(@FarmDefenseInputSystem wrapper) { m_Wrapper = wrapper; }
    ...
    {
        private @FarmDefenseInputSystem m_Wrapper;
        public PlayerMenuUIActions(@FarmDefenseInputSystem wrapper) { m_Wrapper = wrapper; }
